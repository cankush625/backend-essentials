...
)  # (base/settings/base.py - 3 = backend_essentials/)
APPS_DIR = ROOT_DIR
...
SECRET_KEY = "django-insecure-)1e0(77#5qi)9-oeq+vpv614_=of97zjjvawryivo=uvy0l1(w"
...
LOCAL_APPS = ["backend_essentials.core"]
THIRD_PARTY_APPS = []
